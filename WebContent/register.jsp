...
<!--                         </div> -->
                        ...
                        <div id="register" class="animate form">
                            <form  action="registerUser.jsp" autocomplete="on"> 
                                ...
                                {
                                	session.setAttribute("result","");
	                                if(result.equals("New User Successfully Registered!"))
	                                {
	                                	%><label style="color:green;"> New User Successfully Registered! </label><%
	                                }
	                                else
	                                {
	                                	%><label style="color:red;"> New User Registration Failed! </label><%
	                                }
	                                result="";
                                }
                                ...
                                Already a member ?
									<a href="login.jsp" class="to_register" style="margin-right:64px;"> Go and log in </a> 
